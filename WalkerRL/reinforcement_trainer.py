...
from reinforcement_agent import ReinforceAgent
...
class ReinforceTrainer:
    ...
    def train(self) -> tuple[list, list]: 
        ...
        ---
        Returns:
            tuple: episode_lengths, episode_returns

                episode_lengths - The duration of the episode
                episode_returns - The total reward for the episode
        """
     # Keep track of the episode lengths and returns
        ...
        for episode in range(self.n_episodes + 1):
            ...
            if episode % self.evaluate_interval == 0:   
                ...
                print(f'Episode {episode}/{self.n_episodes} Average Length: {avg_length:.2f}, Average Return: {avg_return:.2f}')
